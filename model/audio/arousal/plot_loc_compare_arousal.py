...
def main(tiles_data_path, config_path, experiment):
	...
	for cond_str in cond_list:
		...
		sns.boxplot(x="time", y=data_cols[0], hue='loc', data=plot_data_df, palette="seismic", ax=axes[0][0])
		sns.boxplot(x="time", y=data_cols[1], hue='loc', data=plot_data_df, palette="seismic", ax=axes[0][1])
		sns.boxplot(x="time", y=data_cols[2], hue='loc', data=plot_data_df, palette="seismic", ax=axes[0][2])
		sns.boxplot(x="time", y=data_cols[3], hue='loc', data=plot_data_df, palette="seismic", ax=axes[1][0])
		sns.boxplot(x="time", y=data_cols[4], hue='loc', data=plot_data_df, palette="seismic", ax=axes[1][1])
		sns.boxplot(x="time", y=data_cols[5], hue='loc', data=plot_data_df, palette="seismic", ax=axes[1][2])

		for i in range(2):
			for j in range(3):
				axes[i][j].set_xlim([-0.75, num_of_sec - 0.25])
				axes[i][j].set_xlabel('')
				axes[i][j].set_ylabel('')
				...
				axes[i][j].legend(handles=handles[0:], labels=labels[0:], prop={'size': 10.5})
