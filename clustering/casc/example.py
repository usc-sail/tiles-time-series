...
def runCASC(inputName, outputDir):
    solver = CASCSolver(window_size=3, number_of_clusters=10, lambda_parameter=1e-3, beta=25, threshold=2e-5,
                        gamma=0.8, input_file=inputName, num_proc=10, maxMotifs=50, motifReq=10, maxIters=5)
