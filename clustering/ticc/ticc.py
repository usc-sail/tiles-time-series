...
def main(tiles_data_path, config_path, experiement):
    ...
    for idx, participant_id in enumerate(top_participant_id_list):
        ...
        ###########################################################
        ticc = TICC(data_config=data_config, lambda_parameter=1e-2, beta=100, maxIters=300, threshold=2e-5, num_proc=1,
                    window_size=data_config.fitbit_sensor_dict['cluster_window'],
